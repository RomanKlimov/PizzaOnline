...
<a class="fixed-top logo" href="/home"><img id="logo" src="/img/logo_transparent (2).png" alt="Page Logo"/>
    <nav id="header" class="navbar navbar-expand-lg navbar-light fixed-top fixed-theme">
        <div id="header-container" class="container navbar-container fixepublicd-theme">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto nav-pos">
                    <li class="nav-item active" >
                        <a class="nav-link" href="/admin/clients" >Пользователи <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/couriers">Курьеры</a>
                    </li>
                    <li class="nav-item">
